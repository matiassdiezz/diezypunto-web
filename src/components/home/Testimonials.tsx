...
const REVIEWS: Review[] = [
  ...
  },
  {
    name: "Carolina Levy",
    stars: 5,
    text: "Les pedimos 100 lapiceras con Logo de la empresa, las cuales llegaron a tiempo y en perfecto estado. Sin dudas volvería a comprarles.",
  },
  {
  ...
  },
  {
    name: "Luciana D",
    stars: 5,
    text: "Excelente atención y calidad de producto. Muy recomendable, definitivamente volveré a comprar.",
  },
  {
    name: "Carlos Alegre",
    stars: 4,
...
export default function Testimonials() {
  return (
    <section className="bg-white px-6 lg:px-16 py-14">
      <ScrollReveal>
        <h2 className="text-center text-xl md:text-2xl tracking-tight font-bold">
      ...
      {/* Google review cards — horizontal scroll */}
      ...
      <div className="mt-4 text-center">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-border bg-white px-5 py-2.5 text-sm font-medium text-foreground transition-all hover:border-accent hover:bg-accent/5 hover:text-accent"
        >
