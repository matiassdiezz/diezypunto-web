...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center gap-12 px-6 lg:px-16 pb-12 pt-12 md:flex-row md:items-center md:gap-8 md:pb-20 md:pt-16 lg:gap-16">
        {/* Left — Copy */}
